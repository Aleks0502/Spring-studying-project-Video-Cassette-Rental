...
import ru.melkov.springcourse.VCRApp.repositories.PeopleRepository;
...
public class PeopleService {
    ...
    public List<Videocassette> getBooksByPersonId(int id) {
        return peopleRepository.findById(id).get().getVideocassetteList();
    }
